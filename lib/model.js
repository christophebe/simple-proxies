...
var CheckConfig = function () {
  ...
  this.setCheckBannedByGoogle = function (value) {
    this.checkBannedByGoogle = value;
    return this;
  }
...
var FileConfig = function () {
    ...
    //this.persist = false, //Persist the proxies into a DB
    this.persist = false,
...
var PmConfig = function () {
    ...
    this.pm = null,  // a pm has to implement methods used to retrieve & persist the proxies
                     // see mongoDBStore.js
    this.updateProxies = true // If hasToCheckProxies && updateProxies => update the proxies status (valid or not)
